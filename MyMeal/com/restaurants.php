...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">               
                    <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="restaurants.php">Choose Food Point</a></li>
                        ...
                        <div class="widget clearfix">
                            ...
                            <div class="widget-body">
                                <ul class="tags">
                                    ...
                                    <li>
                                        <a href="#" class="tag">Aalu Paratha</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tag">MyMeal Special</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tag">Non-Veg</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tag">Desert</a> 
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src=" " alt=" "> </a> <span>You Choose | We Delever  </span> </div>
