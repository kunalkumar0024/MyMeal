...
<head>
    ...
    <title>MyMeal.com - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Food Points</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allrestraunt.php">All Food Points</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_restraunt.php">Add Food Points</a></li>
                                
                            </ul>
                        </li>
                        <li> <a class="has-arrowsec" href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20" id="divTableOrders">
                                           ...
                                           <?php
											...
											<tr>
                                                ...
                                                <td><center>
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $rows['o_id'] ?>">
                                                    Take Action
                                                    </button>

                                                    <!-- The Modal -->
                                                    <div class="modal" id="myModal<?php echo $rows['o_id']; ?>">
                                                            ...
                                                            <div>
                                                                <form name="updateticket" id="updatecomplaint" method="POST">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <label class="control-label" style="float:left;">Order Number</label>
                                                                                <input type="text" class="form-control" name="order_id" readonly value="<?php echo $rows['o_id']; ?>">
                                                ...
                                                <!-- <td><center>
												    <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=here php code was present');" title="Update order">
													<button type="button" class="btn btn-primary">Take Action</button></a>
													</center>
											    </td>-->
                                                 <!-- echo htmlentities($rows['o_id']) -->
											</tr> 
                                        </tbody>
                                    </table>
                                </div>
...
<!-- End Container fluid  -->
<!-- footer -->
<footer class="footer"> © 2022 All Right Reserved to MyMeal.com</footer>
<!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
