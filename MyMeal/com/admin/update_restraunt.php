                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Food Points</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_restraunt.php">Add Food Point</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Food Points Info</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Options</a></li>
                        <li class="breadcrumb-item active">Food Points</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update Food Point</h4>
                                    ...
                                    <div class="form-body">
                                       <?php $ssql ="select * from restaurant where rs_id='$_GET[res_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Food Point Name</label>
                                        ...
                                        <!--/row-->
                                        <h3 class="box-title m-t-40">Food Point Address</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
