                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                        <tr>	
                                                            ...
                                                            <span class="btn btn-info" style="font-weight:bold; border-radius:25px;">Dispatch</span>
                                                            <?php 
                                                                }
                                                                if($status=="in process")
                                                                { ?>
                                                                    <span class="btn btn-warning" style="font-weight:bold; border-radius:25px;"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>On the Way!</span>
                                                            <?php
                                                                }
                                                                if($status=="closed")
                                                                {
                                                            ?>
                                                                <span class="btn btn-success"  style="font-weight:bold; border-radius:25px;"><span  class="fa fa-check-circle" aria-hidden="true">Delivered</span> 
                                                            <?php 
                                                                } 
                                                            ?>
                                                            <?php
                                                                ...
                                                                {
                                                            ?>
                                                                <span class="btn btn-danger" style="font-weight:bold; border-radius:25px;" aria-hidden="true"> <i class="fa fa-close"></i>Cancelled</span>
                                                            <?php 
                                                                } 
                                                            ?>													   
                                                            </td>
