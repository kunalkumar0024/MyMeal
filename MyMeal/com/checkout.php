...
if(empty($_SESSION["user_id"]))
{
	...
	{	
        $item_totalAmt += ($item["price"]*$item["quantity"]);									
		$item_total += ($item["price"]*$item["quantity"]);

		if($_POST['submit'])
		{
		    // $SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
            $SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item_totalAmt."')";
			    mysqli_query($db,$SQL);
...
<body>
    ...
    <div class="site-wrapper">
        ...
        <div class="page-wrapper">
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Food point</a></li>
			...
			<form id="frmChckOut" action="" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <p class="text-xs-center"> <input type="submit" id="btnSubmit" name="submit" class="btn btn-outline-success btn-block" value="Order now"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>MyMeal.com - We deliver to serve</h3>
                                <p>Got Hungry? Get the food you want, from the food points you love, delivered at blinking speed.
